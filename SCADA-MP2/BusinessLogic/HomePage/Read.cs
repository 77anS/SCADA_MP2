    ...
    class Read
    {
        public void MappingData()
        {
            ...
            */
            ...
            bool lowValue = Program.PLC1_DB43.Low_beGom_float;
            bool mediValue = Program.PLC1_DB43.Medium_beGom_float;
            bool highValue = Program.PLC1_DB43.High_beGom_float;
                        ...
                        case false: // 00x
                            switch (highValue)
                            {
                                case false: //=> LOW LEVEL
                                            // LOW LIGHT: TURN ON
                                    floatLow_GD1_beGom.DiscreteValue1 = true;
                                    floatLow_GD1_beGom.DiscreteValue2 = false;
                                    floatLow_GD1_beGom.DiscreteValue3 = false;
                                    // MEDIUM LIGHT: TURN OFF
                                    floatMedium_GD1_beGom.DiscreteValue1 = false;
                                    floatMedium_GD1_beGom.DiscreteValue2 = true;
                                    floatMedium_GD1_beGom.DiscreteValue3 = false;
                                    // HIGH LIGHT: TURN OFF
                                    floatHigh_GD1_beGom.DiscreteValue1 = false;
                                    floatHigh_GD1_beGom.DiscreteValue2 = true;
                                    floatHigh_GD1_beGom.DiscreteValue3 = false;
                                    break;
                                case true: // FLOAT ERROR : L-M-H: 001 => ALARM (H)
                                           // LOW LIGHT: TURN OFF
                                    floatLow_GD1_beGom.DiscreteValue1 = false;
                                    floatLow_GD1_beGom.DiscreteValue2 = true;
                                    floatLow_GD1_beGom.DiscreteValue3 = false;
                                    // MEDIUM LIGHT: TURN OFF
                                    floatMedium_GD1_beGom.DiscreteValue1 = false;
                                    floatMedium_GD1_beGom.DiscreteValue2 = true;
                                    ...
                                    floatHigh_GD1_beGom.DiscreteValue1 = false;
                                    floatHigh_GD1_beGom.DiscreteValue2 = false;
                                    floatHigh_GD1_beGom.DiscreteValue3 = true;
                                    break;
                        ...
                        case true: // 01x
                            switch (highValue)
                            {
                                case false: // 010 => ALARM (M)
                                    ...
                                    floatMedium_GD1_beGom.DiscreteValue1 = false;
                                    floatMedium_GD1_beGom.DiscreteValue2 = false;
                                    floatMedium_GD1_beGom.DiscreteValue3 = true;
                                    // HIGH LIGHT: TURN OFF
                                    floatHigh_GD1_beGom.DiscreteValue1 = false;
                                    floatHigh_GD1_beGom.DiscreteValue2 = true;
                                    floatHigh_GD1_beGom.DiscreteValue3 = false;
                                ...
                                case true: // FLOAT ERROR : L-M-H: 011 => ALARM (L)
                                    ...
                                    floatLow_GD1_beGom.DiscreteValue1 = false;
                                    floatLow_GD1_beGom.DiscreteValue2 = false;
                                    floatLow_GD1_beGom.DiscreteValue3 = true;
                                    // MEDIUM LIGHT: TURN OFF
                                    floatMedium_GD1_beGom.DiscreteValue1 = false;
                                    floatMedium_GD1_beGom.DiscreteValue2 = true;
                                    floatMedium_GD1_beGom.DiscreteValue3 = false;
                        ...
                        case true: // 11x
                            switch (highValue)
                            {
                                case false: // L-M-H: 110 => MEDIUM LEVEL
                                    ...
                                    floatMedium_GD1_beGom.DiscreteValue1 = true;
                                    floatMedium_GD1_beGom.DiscreteValue2 = false;
                                    floatMedium_GD1_beGom.DiscreteValue3 = false;
                                    // HIGH LIGHT: TURN OFF
                                    floatHigh_GD1_beGom.DiscreteValue1 = false;
                                ...
                                case true: // L-M-H: 111 => HIGH LEVEL
                                    ...
                                    floatMedium_GD1_beGom.DiscreteValue3 = false;
                                    // HIGH LIGHT: TURN ON
                                    floatHigh_GD1_beGom.DiscreteValue1 = true;
                                    floatHigh_GD1_beGom.DiscreteValue2 = false;
                                    floatHigh_GD1_beGom.DiscreteValue3 = false;
                                    break;
            ...
            if ((Program.PLC3_DB55.low_dieuHoa_float == false) && (Program.PLC3_DB55.high_dieuHoa_float == false))
            {
                floatLowBeDieuHoa.DiscreteValue1 = false; // Off
                floatLowBeDieuHoa.DiscreteValue2 = false; // Green
                floatLowBeDieuHoa.DiscreteValue3 = false; // Blink Yellow

                floatHighBeDieuHoa.DiscreteValue1 = false; // Off
                floatHighBeDieuHoa.DiscreteValue2 = false; // Green
                floatHighBeDieuHoa.DiscreteValue3 = false; // Blink Yellow
            }

            if ((Program.PLC3_DB55.low_dieuHoa_float == false) && (Program.PLC3_DB55.high_dieuHoa_float == true))
            {
                floatLowBeDieuHoa.DiscreteValue1 = false; // Off
                floatLowBeDieuHoa.DiscreteValue2 = false; // Green
                floatLowBeDieuHoa.DiscreteValue3 = true; // Blink Yellow

                floatHighBeDieuHoa.DiscreteValue1 = false; // Off
                floatHighBeDieuHoa.DiscreteValue2 = false; // Green
                floatHighBeDieuHoa.DiscreteValue3 = true; // Blink Yellow
            }

            if ((Program.PLC3_DB55.low_dieuHoa_float == true) && (Program.PLC3_DB55.high_dieuHoa_float == false))
            {
                floatLowBeDieuHoa.DiscreteValue1 = false; // Off
                floatLowBeDieuHoa.DiscreteValue2 = true; // Green
                floatLowBeDieuHoa.DiscreteValue3 = false; // Blink Yellow
            ...
            if ((Program.PLC3_DB55.low_dieuHoa_float == true) && (Program.PLC3_DB55.high_dieuHoa_float == true))
            {
                floatLowBeDieuHoa.DiscreteValue1 = false; // Off
                floatLowBeDieuHoa.DiscreteValue2 = false; // Green
                floatLowBeDieuHoa.DiscreteValue3 = false; // Blink Yellow
                ...
                floatHighBeDieuHoa.DiscreteValue1 = false; // Off
                floatHighBeDieuHoa.DiscreteValue2 = true; // Green
                floatHighBeDieuHoa.DiscreteValue3 = false; // Blink Yellow
            }
            #endregion
            ...
            if (Program.PLC3_DB55.float_beBun05_float)
            {
                floatHigh_hl05.DiscreteValue1 = false;
                floatHigh_hl05.DiscreteValue2 = true; // Green
            }
            else
            {
                floatHigh_hl05.DiscreteValue1 = true; //Grey
                floatHigh_hl05.DiscreteValue2 = false; // Green
            }

            if (Program.PLC3_DB55.float_beBun07_float)
            {
                floatHigh_hl07.DiscreteValue1 = false;
                floatHigh_hl07.DiscreteValue2 = true; // Green
            }
            else
            {
                floatHigh_hl07.DiscreteValue1 = true; //Grey
                floatHigh_hl07.DiscreteValue2 = false; // Green
            }

            if (Program.PLC3_DB55.float_beBunSP10_float)
            {
                floatHigh_SP10_beBun.DiscreteValue1 = false;
                floatHigh_SP10_beBun.DiscreteValue2 = true; // Green
            }
            else
            {
                floatHigh_SP10_beBun.DiscreteValue1 = true; //Grey
                floatHigh_SP10_beBun.DiscreteValue2 = false; // Green
            }
            #endregion
            ...
            {
                mayTachRac_bs02a.DiscreteValue1 = false;
                mayTachRac_bs02a.DiscreteValue2 = true;
                mayTachRac_bs02a.DiscreteValue3 = false;
                mayTachRac_bs02a.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mayTachRac_runStatus == false && Program.InputStatus_PLC3.mayTachRac_tripStatus == true)
            {
                mayTachRac_bs02a.DiscreteValue1 = false;
                mayTachRac_bs02a.DiscreteValue2 = false;
                mayTachRac_bs02a.DiscreteValue3 = true;
                mayTachRac_bs02a.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mayTachRac_runStatus == true && Program.InputStatus_PLC3.mayTachRac_tripStatus == true)
            {
                ...
                mayTachRac_bs02a.DiscreteValue2 = false;
                mayTachRac_bs02a.DiscreteValue3 = false;
                mayTachRac_bs02a.DiscreteValue4 = true;
            }
            else
            {
                mayTachRac_bs02a.DiscreteValue1 = true;
                mayTachRac_bs02a.DiscreteValue2 = false;
                mayTachRac_bs02a.DiscreteValue3 = false;
                mayTachRac_bs02a.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mtk01.DiscreteValue1 = false;
                airPump_mtk01.DiscreteValue2 = true;
                airPump_mtk01.DiscreteValue3 = false;
                airPump_mtk01.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk01_runStatus == false) & (Program.InputStatus_PLC1.mtk01_tripStatus == true))
            {
                airPump_mtk01.DiscreteValue1 = false;
                airPump_mtk01.DiscreteValue2 = false;
                airPump_mtk01.DiscreteValue3 = true;
                airPump_mtk01.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk01_runStatus == true) & (Program.InputStatus_PLC1.mtk01_tripStatus == true))
            {
                ...
                airPump_mtk01.DiscreteValue2 = false;
                airPump_mtk01.DiscreteValue3 = false;
                airPump_mtk01.DiscreteValue4 = true;
            }
            else
            {
                airPump_mtk01.DiscreteValue1 = true;
                airPump_mtk01.DiscreteValue2 = false;
                airPump_mtk01.DiscreteValue3 = false;
                airPump_mtk01.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mtk02.DiscreteValue1 = false;
                airPump_mtk02.DiscreteValue2 = true;
                airPump_mtk02.DiscreteValue3 = false;
                airPump_mtk02.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk02_runStatus == false) & (Program.InputStatus_PLC1.mtk02_tripStatus == true))
            {
                airPump_mtk02.DiscreteValue1 = false;
                airPump_mtk02.DiscreteValue2 = false;
                airPump_mtk02.DiscreteValue3 = true;
                airPump_mtk02.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk02_runStatus == true) & (Program.InputStatus_PLC1.mtk02_tripStatus == true))
            {
                ...
                airPump_mtk02.DiscreteValue2 = false;
                airPump_mtk02.DiscreteValue3 = false;
                airPump_mtk02.DiscreteValue4 = true;
            }
            else
            {
                airPump_mtk02.DiscreteValue1 = true;
                airPump_mtk02.DiscreteValue2 = false;
                airPump_mtk02.DiscreteValue3 = false;
                airPump_mtk02.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mtk03.DiscreteValue1 = false;
                airPump_mtk03.DiscreteValue2 = true;
                airPump_mtk03.DiscreteValue3 = false;
                airPump_mtk03.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk03_runStatus == false) & (Program.InputStatus_PLC1.mtk03_tripStatus == true))
            {
                airPump_mtk03.DiscreteValue1 = false;
                airPump_mtk03.DiscreteValue2 = false;
                airPump_mtk03.DiscreteValue3 = true;
                airPump_mtk03.DiscreteValue4 = false;
            }
            else if ((Program.InputStatus_PLC1.mtk03_runStatus == true) & (Program.InputStatus_PLC1.mtk03_tripStatus == true))
            {
                ...
                airPump_mtk03.DiscreteValue2 = false;
                airPump_mtk03.DiscreteValue3 = false;
                airPump_mtk03.DiscreteValue4 = true;
            }
            else
            {
                airPump_mtk03.DiscreteValue1 = true;
                airPump_mtk03.DiscreteValue2 = false;
                airPump_mtk03.DiscreteValue3 = false;
                airPump_mtk03.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mkt01.DiscreteValue1 = false;
                airPump_mkt01.DiscreteValue2 = true;
                airPump_mkt01.DiscreteValue3 = false;
                airPump_mkt01.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt01_runStatus == false && Program.InputStatus_PLC2.mkt01_tripStatus == true)
            {
                airPump_mkt01.DiscreteValue1 = false;
                airPump_mkt01.DiscreteValue2 = false;
                airPump_mkt01.DiscreteValue3 = true;
                airPump_mkt01.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt01_runStatus == true && Program.InputStatus_PLC2.mkt01_tripStatus == true)
            {
                ...
                airPump_mkt01.DiscreteValue2 = false;
                airPump_mkt01.DiscreteValue3 = false;
                airPump_mkt01.DiscreteValue4 = true;
            }
            else
            {
                airPump_mkt01.DiscreteValue1 = true;
                airPump_mkt01.DiscreteValue2 = false;
                airPump_mkt01.DiscreteValue3 = false;
                airPump_mkt01.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mkt02.DiscreteValue1 = false;
                airPump_mkt02.DiscreteValue2 = true;
                airPump_mkt02.DiscreteValue3 = false;
                airPump_mkt02.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt02_runStatus == false && Program.InputStatus_PLC2.mkt02_tripStatus == true)
            {
                airPump_mkt02.DiscreteValue1 = false;
                airPump_mkt02.DiscreteValue2 = false;
                airPump_mkt02.DiscreteValue3 = true;
                airPump_mkt02.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt02_runStatus == true && Program.InputStatus_PLC2.mkt02_tripStatus == true)
            {
                ...
                airPump_mkt02.DiscreteValue2 = false;
                airPump_mkt02.DiscreteValue3 = false;
                airPump_mkt02.DiscreteValue4 = true;
            }
            else
            {
                airPump_mkt02.DiscreteValue1 = true;
                airPump_mkt02.DiscreteValue2 = false;
                airPump_mkt02.DiscreteValue3 = false;
                airPump_mkt02.DiscreteValue4 = false;
            }
            ...
            {
                airPump_mkt03.DiscreteValue1 = false;
                airPump_mkt03.DiscreteValue2 = true;
                airPump_mkt03.DiscreteValue3 = false;
                airPump_mkt03.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt03_runStatus == false && Program.InputStatus_PLC2.mkt03_tripStatus == true)
            {
                airPump_mkt03.DiscreteValue1 = false;
                airPump_mkt03.DiscreteValue2 = false;
                airPump_mkt03.DiscreteValue3 = true;
                airPump_mkt03.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC2.mkt03_runStatus == true && Program.InputStatus_PLC2.mkt03_tripStatus == true)
            {
                ...
                airPump_mkt03.DiscreteValue2 = false;
                airPump_mkt03.DiscreteValue3 = false;
                airPump_mkt03.DiscreteValue4 = true;
            }
            else
            {
                airPump_mkt03.DiscreteValue1 = true;
                airPump_mkt03.DiscreteValue2 = false;
                airPump_mkt03.DiscreteValue3 = false;
                airPump_mkt03.DiscreteValue4 = false;
            }
            ...
            {
                airPump_ab06a.DiscreteValue1 = false;
                airPump_ab06a.DiscreteValue2 = true;
                airPump_ab06a.DiscreteValue3 = false;
                airPump_ab06a.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06A_runStatus == false && Program.InputStatus_PLC3.mtk_AB06A_tripStatus == true)
            {
                airPump_ab06a.DiscreteValue1 = false;
                airPump_ab06a.DiscreteValue2 = false;
                airPump_ab06a.DiscreteValue3 = true;
                airPump_ab06a.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06A_runStatus == true && Program.InputStatus_PLC3.mtk_AB06A_tripStatus == true)
            {
                ...
                airPump_ab06a.DiscreteValue2 = false;
                airPump_ab06a.DiscreteValue3 = false;
                airPump_ab06a.DiscreteValue4 = true;
            }
            else
            {
                airPump_ab06a.DiscreteValue1 = true;
                airPump_ab06a.DiscreteValue2 = false;
                airPump_ab06a.DiscreteValue3 = false;
                airPump_ab06a.DiscreteValue4 = false;
            }
            ...
            {
                airPump_ab06b.DiscreteValue1 = false;
                airPump_ab06b.DiscreteValue2 = true;
                airPump_ab06b.DiscreteValue3 = false;
                airPump_ab06b.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06B_runStatus == false && Program.InputStatus_PLC3.mtk_AB06B_tripStatus == true)
            {
                airPump_ab06b.DiscreteValue1 = false;
                airPump_ab06b.DiscreteValue2 = false;
                airPump_ab06b.DiscreteValue3 = true;
                airPump_ab06b.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06B_runStatus == true && Program.InputStatus_PLC3.mtk_AB06B_tripStatus == true)
            {
                ...
                airPump_ab06b.DiscreteValue2 = false;
                airPump_ab06b.DiscreteValue3 = false;
                airPump_ab06b.DiscreteValue4 = true;
            }
            else
            {
                airPump_ab06b.DiscreteValue1 = true;
                airPump_ab06b.DiscreteValue2 = false;
                airPump_ab06b.DiscreteValue3 = false;
                airPump_ab06b.DiscreteValue4 = false;
            }
            ...
            {
                airPump_ab06c.DiscreteValue1 = false;
                airPump_ab06c.DiscreteValue2 = true;
                airPump_ab06c.DiscreteValue3 = false;
                airPump_ab06c.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06C_runStatus == false && Program.InputStatus_PLC3.mtk_AB06C_tripStatus == true)
            {
                airPump_ab06c.DiscreteValue1 = false;
                airPump_ab06c.DiscreteValue2 = false;
                airPump_ab06c.DiscreteValue3 = true;
                airPump_ab06c.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.mtk_AB06C_runStatus == true && Program.InputStatus_PLC3.mtk_AB06C_tripStatus == true)
            {
                ...
                airPump_ab06c.DiscreteValue2 = false;
                airPump_ab06c.DiscreteValue3 = false;
                airPump_ab06c.DiscreteValue4 = true;
            }
            else
            {
                airPump_ab06c.DiscreteValue1 = true;
                airPump_ab06c.DiscreteValue2 = false;
                airPump_ab06c.DiscreteValue3 = false;
                airPump_ab06c.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP04A.DiscreteValue1 = false;
                dlPump_DP04A.DiscreteValue2 = true;
                dlPump_DP04A.DiscreteValue3 = false;
                dlPump_DP04A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPolyme_04A_runStatus == false && Program.InputStatus_PLC3.dlPolyme_04A_tripStatus == true)
            {
                dlPump_DP04A.DiscreteValue1 = false;
                dlPump_DP04A.DiscreteValue2 = false;
                dlPump_DP04A.DiscreteValue3 = true;
                dlPump_DP04A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPolyme_04A_runStatus == true && Program.InputStatus_PLC3.dlPolyme_04A_tripStatus == true)
            {
                ...
                dlPump_DP04A.DiscreteValue2 = false;
                dlPump_DP04A.DiscreteValue3 = false;
                dlPump_DP04A.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP04A.DiscreteValue1 = true;
                dlPump_DP04A.DiscreteValue2 = false;
                dlPump_DP04A.DiscreteValue3 = false;
                dlPump_DP04A.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP04B.DiscreteValue1 = false;
                dlPump_DP04B.DiscreteValue2 = true;
                dlPump_DP04B.DiscreteValue3 = false;
                dlPump_DP04B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPolyme_04B_runStatus == false && Program.InputStatus_PLC3.dlPolyme_04B_tripStatus == true)
            {
                dlPump_DP04B.DiscreteValue1 = false;
                dlPump_DP04B.DiscreteValue2 = false;
                dlPump_DP04B.DiscreteValue3 = true;
                dlPump_DP04B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPolyme_04B_runStatus == true && Program.InputStatus_PLC3.dlPolyme_04B_tripStatus == true)
            {
                ...
                dlPump_DP04B.DiscreteValue2 = false;
                dlPump_DP04B.DiscreteValue3 = false;
                dlPump_DP04B.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP04B.DiscreteValue1 = true;
                dlPump_DP04B.DiscreteValue2 = false;
                dlPump_DP04B.DiscreteValue3 = false;
                dlPump_DP04B.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP03A.DiscreteValue1 = false;
                dlPump_DP03A.DiscreteValue2 = true;
                dlPump_DP03A.DiscreteValue3 = false;
                dlPump_DP03A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPhen_03A_runStatus == false && Program.InputStatus_PLC3.dlPhen_03A_tripStatus == true)
            {
                dlPump_DP03A.DiscreteValue1 = false;
                dlPump_DP03A.DiscreteValue2 = false;
                dlPump_DP03A.DiscreteValue3 = true;
                dlPump_DP03A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPhen_03A_runStatus == true && Program.InputStatus_PLC3.dlPhen_03A_tripStatus == true)
            {
                ...
                dlPump_DP03A.DiscreteValue2 = false;
                dlPump_DP03A.DiscreteValue3 = false;
                dlPump_DP03A.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP03A.DiscreteValue1 = true;
                dlPump_DP03A.DiscreteValue2 = false;
                dlPump_DP03A.DiscreteValue3 = false;
                dlPump_DP03A.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP03B.DiscreteValue1 = false;
                dlPump_DP03B.DiscreteValue2 = true;
                dlPump_DP03B.DiscreteValue3 = false;
                dlPump_DP03B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPhen_03B_runStatus == false && Program.InputStatus_PLC3.dlPhen_03B_tripStatus == true)
            {
                dlPump_DP03B.DiscreteValue1 = false;
                dlPump_DP03B.DiscreteValue2 = false;
                dlPump_DP03B.DiscreteValue3 = true;
                dlPump_DP03B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlPhen_03B_runStatus == true && Program.InputStatus_PLC3.dlPhen_03B_tripStatus == true)
            {
                ...
                dlPump_DP03B.DiscreteValue2 = false;
                dlPump_DP03B.DiscreteValue3 = false;
                dlPump_DP03B.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP03B.DiscreteValue1 = true;
                dlPump_DP03B.DiscreteValue2 = false;
                dlPump_DP03B.DiscreteValue3 = false;
                dlPump_DP03B.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP05A.DiscreteValue1 = false;
                dlPump_DP05A.DiscreteValue2 = true;
                dlPump_DP05A.DiscreteValue3 = false;
                dlPump_DP05A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlXut_05A_runStatus == false && Program.InputStatus_PLC3.dlXut_05A_tripStatus == true)
            {
                dlPump_DP05A.DiscreteValue1 = false;
                dlPump_DP05A.DiscreteValue2 = false;
                dlPump_DP05A.DiscreteValue3 = true;
                dlPump_DP05A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlXut_05A_runStatus == true && Program.InputStatus_PLC3.dlXut_05A_tripStatus == true)
            {
                ...
                dlPump_DP05A.DiscreteValue2 = false;
                dlPump_DP05A.DiscreteValue3 = false;
                dlPump_DP05A.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP05A.DiscreteValue1 = true;
                dlPump_DP05A.DiscreteValue2 = false;
                dlPump_DP05A.DiscreteValue3 = false;
                dlPump_DP05A.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP05B.DiscreteValue1 = false;
                dlPump_DP05B.DiscreteValue2 = true;
                dlPump_DP05B.DiscreteValue3 = false;
                dlPump_DP05B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlXut_05B_runStatus == false && Program.InputStatus_PLC3.dlXut_05B_tripStatus == true)
            {
                dlPump_DP05B.DiscreteValue1 = false;
                dlPump_DP05B.DiscreteValue2 = false;
                dlPump_DP05B.DiscreteValue3 = true;
                dlPump_DP05B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlXut_05B_runStatus == true && Program.InputStatus_PLC3.dlXut_05B_tripStatus == true)
            {
                ...
                dlPump_DP05B.DiscreteValue2 = false;
                dlPump_DP05B.DiscreteValue3 = false;
                dlPump_DP05B.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP05B.DiscreteValue1 = true;
                dlPump_DP05B.DiscreteValue2 = false;
                dlPump_DP05B.DiscreteValue3 = false;
                dlPump_DP05B.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP06A.DiscreteValue1 = false;
                dlPump_DP06A.DiscreteValue2 = true;
                dlPump_DP06A.DiscreteValue3 = false;
                dlPump_DP06A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlDd_06A_runStatus == false && Program.InputStatus_PLC3.dlDd_06A_tripStatus == true)
            {
                dlPump_DP06A.DiscreteValue1 = false;
                dlPump_DP06A.DiscreteValue2 = false;
                dlPump_DP06A.DiscreteValue3 = true;
                dlPump_DP06A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlDd_06A_runStatus == true && Program.InputStatus_PLC3.dlDd_06A_tripStatus == true)
            {
                ...
                dlPump_DP06A.DiscreteValue2 = false;
                dlPump_DP06A.DiscreteValue3 = false;
                dlPump_DP06A.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP06A.DiscreteValue1 = true;
                dlPump_DP06A.DiscreteValue2 = false;
                dlPump_DP06A.DiscreteValue3 = false;
                dlPump_DP06A.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP06B.DiscreteValue1 = false;
                dlPump_DP06B.DiscreteValue2 = true;
                dlPump_DP06B.DiscreteValue3 = false;
                dlPump_DP06B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlDd_06B_runStatus == false && Program.InputStatus_PLC3.dlDd_06B_tripStatus == true)
            {
                dlPump_DP06B.DiscreteValue1 = false;
                dlPump_DP06B.DiscreteValue2 = false;
                dlPump_DP06B.DiscreteValue3 = true;
                dlPump_DP06B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlDd_06B_runStatus == true && Program.InputStatus_PLC3.dlDd_06B_tripStatus == true)
            {
                ...
                dlPump_DP06B.DiscreteValue2 = false;
                dlPump_DP06B.DiscreteValue3 = false;
                dlPump_DP06B.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP06B.DiscreteValue1 = true;
                dlPump_DP06B.DiscreteValue2 = false;
                dlPump_DP06B.DiscreteValue3 = false;
                dlPump_DP06B.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP07A.DiscreteValue1 = false;
                dlPump_DP07A.DiscreteValue2 = true;
                dlPump_DP07A.DiscreteValue3 = false;
                dlPump_DP07A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlKhuTrung_07A_runStatus == false && Program.InputStatus_PLC3.dlKhuTrung_07A_tripStatus == true)
            {
                dlPump_DP07A.DiscreteValue1 = false;
                dlPump_DP07A.DiscreteValue2 = false;
                dlPump_DP07A.DiscreteValue3 = true;
                dlPump_DP07A.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlKhuTrung_07A_runStatus == true && Program.InputStatus_PLC3.dlKhuTrung_07A_tripStatus == true)
            {
                ...
                dlPump_DP07A.DiscreteValue2 = false;
                dlPump_DP07A.DiscreteValue3 = false;
                dlPump_DP07A.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP07A.DiscreteValue1 = true;
                dlPump_DP07A.DiscreteValue2 = false;
                dlPump_DP07A.DiscreteValue3 = false;
                dlPump_DP07A.DiscreteValue4 = false;
            }
            ...
            {
                dlPump_DP07B.DiscreteValue1 = false;
                dlPump_DP07B.DiscreteValue2 = true;
                dlPump_DP07B.DiscreteValue3 = false;
                dlPump_DP07B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlKhuTrung_07B_runStatus == false && Program.InputStatus_PLC3.dlKhuTrung_07B_tripStatus == true)
            {
                dlPump_DP07B.DiscreteValue1 = false;
                dlPump_DP07B.DiscreteValue2 = false;
                dlPump_DP07B.DiscreteValue3 = true;
                dlPump_DP07B.DiscreteValue4 = false;
            }
            else if (Program.InputStatus_PLC3.dlKhuTrung_07B_runStatus == true && Program.InputStatus_PLC3.dlKhuTrung_07B_tripStatus == true)
            {
                ...
                dlPump_DP07B.DiscreteValue2 = false;
                dlPump_DP07B.DiscreteValue3 = false;
                dlPump_DP07B.DiscreteValue4 = true;
            }
            else
            {
                dlPump_DP07B.DiscreteValue1 = true;
                dlPump_DP07B.DiscreteValue2 = false;
                dlPump_DP07B.DiscreteValue3 = false;
                dlPump_DP07B.DiscreteValue4 = false;
            }
